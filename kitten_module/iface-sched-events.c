...
static void v3_sched_in(struct preempt_notifier * pn, int cpu) {
...
static struct v3_sched_notifier * find_notifier(int (*sched_in)(void * arg, int cpu),
						int (*sched_out)(void * arg, int cpu),
						void * arg) {
...
static int palacios_hook_sched_evts(int (*sched_in)(void * arg, int cpu),
    ...
    notifier = kmem_alloc(sizeof(struct v3_sched_notifier));
...
static int palacios_unhook_sched_evts(int (*sched_in)(void * arg, int cpu), 
				      int (*sched_out)(void * arg, int cpu), 
				      void * arg) {
    struct v3_sched_notifier * notifier = NULL;
    unsigned long flags;
...
static int sched_events_init( void ) {
...
static int sched_events_deinit( void ) {
    struct v3_sched_notifier * tmp = NULL;
    struct v3_sched_notifier * notifier = NULL;
...
static struct kitten_ext sched_events_ext = {
