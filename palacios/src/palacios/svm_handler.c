		   ...
		   uint64_t              exit_info2) 
{
	...
	case SVM_EXIT_IOIO: {
		...
		if (io_info->str) {
		    ...
		    if (v3_handle_svm_io_outs(core, io_info) == -1 ) {
			return -1;
		    }
		} else {
		    if (v3_handle_svm_io_out(core, io_info)  == -1) {
			return -1;
		    }
		}
		...
		if (io_info->str) {
		    if (v3_handle_svm_io_ins(core, io_info)  == -1) {
			return -1;
		    }
		} else {
		    if (v3_handle_svm_io_in(core, io_info)   == -1) {
			return -1;
		    }
		}
	    }
	...
	case SVM_EXIT_EXCP14: {
		...
		if (v3_handle_shadow_pagefault(core, fault_addr, *error_code) == -1) {
		    return -1;
		}
	    } else {
 	...
 	case SVM_EXIT_NPF: {
		...
		if (v3_handle_nested_pagefault(core, fault_addr, *error_code) == -1) {
		    return -1;
		}
	    } else {
	...
	case SVM_EXIT_INTR:
	    ...
	    break;
	case SVM_EXIT_SMI:
	    //   handle_svm_smi(core); // ignored for now
	    break;
	case SVM_EXIT_HLT:
	...
	case SVM_EXIT_WBINVD:   
	    ...
	    PrintDebug("WBINVD\n");
#endif
	    if (v3_handle_svm_wbinvd(core) == -1) { 
		return -1;
	    }
	    break;
        case SVM_EXIT_RDTSC:
	...
	case SVM_EXIT_SHUTDOWN:
	    ...
	    core->vm_info->run_state = VM_STOPPED;
	...
	default: {
	    ...
	    rip_addr = get_addr_linear(core, core->rip, V3_SEG_CS);
	    
	    
	    PrintError("SVM Returned:(VMCB=%p)\n",           (void *)(core->vmm_data)); 
	    PrintError("RIP: %p\n",                          (void *)(addr_t)(core->rip));
	    PrintError("RIP Linear: %p\n",                   (void *)(addr_t)(rip_addr));
	    PrintError("SVM Returned: Exit Code: 0x%llx\n",  exit_code); 
	    PrintError("io_info1:  0x%llx\n",                exit_info1);
	    PrintError("io_info2:  0x%llx\n",                exit_info2);
	    
	    
	    if (core->shdw_pg_mode == SHADOW_PAGING) {
		//	PrintHostPageTables(core, core->ctrl_regs.cr3);
		//PrintGuestPageTables(core, core->shdw_pg_state.guest_cr3);
	    }
...
#ifdef V3_CONFIG_TELEMETRY
    if (core->vm_info->enable_telemetry) {
	v3_telemetry_end_exit(core, exit_code);
    }
#endif
...
{
    switch(exit_code) {
	case SVM_EXIT_CR0_READ:           return SVM_EXIT_CR0_READ_STR;
	case SVM_EXIT_CR1_READ:           return SVM_EXIT_CR1_READ_STR;
	case SVM_EXIT_CR2_READ:           return SVM_EXIT_CR2_READ_STR;
	case SVM_EXIT_CR3_READ:           return SVM_EXIT_CR3_READ_STR;
	case SVM_EXIT_CR4_READ:           return SVM_EXIT_CR4_READ_STR;
	case SVM_EXIT_CR5_READ:           return SVM_EXIT_CR5_READ_STR;
	case SVM_EXIT_CR6_READ:           return SVM_EXIT_CR6_READ_STR;
	case SVM_EXIT_CR7_READ:           return SVM_EXIT_CR7_READ_STR;
	case SVM_EXIT_CR8_READ:           return SVM_EXIT_CR8_READ_STR;
	case SVM_EXIT_CR9_READ:           return SVM_EXIT_CR9_READ_STR;
	case SVM_EXIT_CR10_READ:          return SVM_EXIT_CR10_READ_STR;
	case SVM_EXIT_CR11_READ:          return SVM_EXIT_CR11_READ_STR;
	case SVM_EXIT_CR12_READ:          return SVM_EXIT_CR12_READ_STR;
	case SVM_EXIT_CR13_READ:          return SVM_EXIT_CR13_READ_STR;
	case SVM_EXIT_CR14_READ:          return SVM_EXIT_CR14_READ_STR;
	case SVM_EXIT_CR15_READ:          return SVM_EXIT_CR15_READ_STR;
	case SVM_EXIT_CR0_WRITE:          return SVM_EXIT_CR0_WRITE_STR;
	case SVM_EXIT_CR1_WRITE:          return SVM_EXIT_CR1_WRITE_STR;
	case SVM_EXIT_CR2_WRITE:          return SVM_EXIT_CR2_WRITE_STR;
	case SVM_EXIT_CR3_WRITE:          return SVM_EXIT_CR3_WRITE_STR;
	case SVM_EXIT_CR4_WRITE:          return SVM_EXIT_CR4_WRITE_STR;
	case SVM_EXIT_CR5_WRITE:          return SVM_EXIT_CR5_WRITE_STR;
	case SVM_EXIT_CR6_WRITE:          return SVM_EXIT_CR6_WRITE_STR;
	case SVM_EXIT_CR7_WRITE:          return SVM_EXIT_CR7_WRITE_STR;
	case SVM_EXIT_CR8_WRITE:          return SVM_EXIT_CR8_WRITE_STR;
	case SVM_EXIT_CR9_WRITE:          return SVM_EXIT_CR9_WRITE_STR;
	case SVM_EXIT_CR10_WRITE:         return SVM_EXIT_CR10_WRITE_STR;
	case SVM_EXIT_CR11_WRITE:         return SVM_EXIT_CR11_WRITE_STR;
	case SVM_EXIT_CR12_WRITE:         return SVM_EXIT_CR12_WRITE_STR;
	case SVM_EXIT_CR13_WRITE:         return SVM_EXIT_CR13_WRITE_STR;
	case SVM_EXIT_CR14_WRITE:         return SVM_EXIT_CR14_WRITE_STR;
	case SVM_EXIT_CR15_WRITE:         return SVM_EXIT_CR15_WRITE_STR;
	case SVM_EXIT_DR0_READ:           return SVM_EXIT_DR0_READ_STR;
	case SVM_EXIT_DR1_READ:           return SVM_EXIT_DR1_READ_STR;
	case SVM_EXIT_DR2_READ:           return SVM_EXIT_DR2_READ_STR;
	case SVM_EXIT_DR3_READ:           return SVM_EXIT_DR3_READ_STR;
	case SVM_EXIT_DR4_READ:           return SVM_EXIT_DR4_READ_STR;
	case SVM_EXIT_DR5_READ:           return SVM_EXIT_DR5_READ_STR;
	case SVM_EXIT_DR6_READ:           return SVM_EXIT_DR6_READ_STR;
	case SVM_EXIT_DR7_READ:           return SVM_EXIT_DR7_READ_STR;
	case SVM_EXIT_DR8_READ:           return SVM_EXIT_DR8_READ_STR;
	case SVM_EXIT_DR9_READ:           return SVM_EXIT_DR9_READ_STR;
	case SVM_EXIT_DR10_READ:          return SVM_EXIT_DR10_READ_STR;
	case SVM_EXIT_DR11_READ:          return SVM_EXIT_DR11_READ_STR;
	case SVM_EXIT_DR12_READ:          return SVM_EXIT_DR12_READ_STR;
	case SVM_EXIT_DR13_READ:          return SVM_EXIT_DR13_READ_STR;
	case SVM_EXIT_DR14_READ:          return SVM_EXIT_DR14_READ_STR;
	case SVM_EXIT_DR15_READ:          return SVM_EXIT_DR15_READ_STR;
	case SVM_EXIT_DR0_WRITE:          return SVM_EXIT_DR0_WRITE_STR;
	case SVM_EXIT_DR1_WRITE:          return SVM_EXIT_DR1_WRITE_STR;
	case SVM_EXIT_DR2_WRITE:          return SVM_EXIT_DR2_WRITE_STR;
	case SVM_EXIT_DR3_WRITE:          return SVM_EXIT_DR3_WRITE_STR;
	case SVM_EXIT_DR4_WRITE:          return SVM_EXIT_DR4_WRITE_STR;
	case SVM_EXIT_DR5_WRITE:          return SVM_EXIT_DR5_WRITE_STR;
	case SVM_EXIT_DR6_WRITE:          return SVM_EXIT_DR6_WRITE_STR;
	case SVM_EXIT_DR7_WRITE:          return SVM_EXIT_DR7_WRITE_STR;
	case SVM_EXIT_DR8_WRITE:          return SVM_EXIT_DR8_WRITE_STR;
	case SVM_EXIT_DR9_WRITE:          return SVM_EXIT_DR9_WRITE_STR;
	case SVM_EXIT_DR10_WRITE:         return SVM_EXIT_DR10_WRITE_STR;
	case SVM_EXIT_DR11_WRITE:         return SVM_EXIT_DR11_WRITE_STR;
	case SVM_EXIT_DR12_WRITE:         return SVM_EXIT_DR12_WRITE_STR;
	case SVM_EXIT_DR13_WRITE:         return SVM_EXIT_DR13_WRITE_STR;
	case SVM_EXIT_DR14_WRITE:         return SVM_EXIT_DR14_WRITE_STR;
	case SVM_EXIT_DR15_WRITE:         return SVM_EXIT_DR15_WRITE_STR;
	case SVM_EXIT_EXCP0:              return SVM_EXIT_EXCP0_STR;
	case SVM_EXIT_EXCP1:              return SVM_EXIT_EXCP1_STR;
	case SVM_EXIT_EXCP2:              return SVM_EXIT_EXCP2_STR;
	case SVM_EXIT_EXCP3:              return SVM_EXIT_EXCP3_STR;
	case SVM_EXIT_EXCP4:              return SVM_EXIT_EXCP4_STR;
	case SVM_EXIT_EXCP5:              return SVM_EXIT_EXCP5_STR;
	case SVM_EXIT_EXCP6:              return SVM_EXIT_EXCP6_STR;
	case SVM_EXIT_EXCP7:              return SVM_EXIT_EXCP7_STR;
	case SVM_EXIT_EXCP8:              return SVM_EXIT_EXCP8_STR;
	case SVM_EXIT_EXCP9:              return SVM_EXIT_EXCP9_STR;
	case SVM_EXIT_EXCP10:             return SVM_EXIT_EXCP10_STR;
	case SVM_EXIT_EXCP11:             return SVM_EXIT_EXCP11_STR;
	case SVM_EXIT_EXCP12:             return SVM_EXIT_EXCP12_STR;
	case SVM_EXIT_EXCP13:             return SVM_EXIT_EXCP13_STR;
	case SVM_EXIT_EXCP14:             return SVM_EXIT_EXCP14_STR;
	case SVM_EXIT_EXCP15:             return SVM_EXIT_EXCP15_STR;
	case SVM_EXIT_EXCP16:             return SVM_EXIT_EXCP16_STR;
	case SVM_EXIT_EXCP17:             return SVM_EXIT_EXCP17_STR;
	case SVM_EXIT_EXCP18:             return SVM_EXIT_EXCP18_STR;
	case SVM_EXIT_EXCP19:             return SVM_EXIT_EXCP19_STR;
	case SVM_EXIT_EXCP20:             return SVM_EXIT_EXCP20_STR;
	case SVM_EXIT_EXCP21:             return SVM_EXIT_EXCP21_STR;
	case SVM_EXIT_EXCP22:             return SVM_EXIT_EXCP22_STR;
	case SVM_EXIT_EXCP23:             return SVM_EXIT_EXCP23_STR;
	case SVM_EXIT_EXCP24:             return SVM_EXIT_EXCP24_STR;
	case SVM_EXIT_EXCP25:             return SVM_EXIT_EXCP25_STR;
	case SVM_EXIT_EXCP26:             return SVM_EXIT_EXCP26_STR;
	case SVM_EXIT_EXCP27:             return SVM_EXIT_EXCP27_STR;
	case SVM_EXIT_EXCP28:             return SVM_EXIT_EXCP28_STR;
	case SVM_EXIT_EXCP29:             return SVM_EXIT_EXCP29_STR;
	case SVM_EXIT_EXCP30:             return SVM_EXIT_EXCP30_STR;
	case SVM_EXIT_EXCP31:             return SVM_EXIT_EXCP31_STR;
	case SVM_EXIT_INTR:               return SVM_EXIT_INTR_STR;
	case SVM_EXIT_NMI:                return SVM_EXIT_NMI_STR;
	case SVM_EXIT_SMI:                return SVM_EXIT_SMI_STR;
	case SVM_EXIT_INIT:               return SVM_EXIT_INIT_STR;
	case SVM_EXIT_VINITR:             return SVM_EXIT_VINITR_STR;
	case SVM_EXIT_CR0_SEL_WRITE:      return SVM_EXIT_CR0_SEL_WRITE_STR;
	case SVM_EXIT_IDTR_READ:          return SVM_EXIT_IDTR_READ_STR;
	case SVM_EXIT_GDTR_READ:          return SVM_EXIT_GDTR_READ_STR;
	case SVM_EXIT_LDTR_READ:          return SVM_EXIT_LDTR_READ_STR;
	case SVM_EXIT_TR_READ:            return SVM_EXIT_TR_READ_STR;
	case SVM_EXIT_IDTR_WRITE:         return SVM_EXIT_IDTR_WRITE_STR;
	case SVM_EXIT_GDTR_WRITE:         return SVM_EXIT_GDTR_WRITE_STR;
	case SVM_EXIT_LDTR_WRITE:         return SVM_EXIT_LDTR_WRITE_STR;
	case SVM_EXIT_TR_WRITE:           return SVM_EXIT_TR_WRITE_STR;
	case SVM_EXIT_RDTSC:              return SVM_EXIT_RDTSC_STR;
	case SVM_EXIT_RDPMC:              return SVM_EXIT_RDPMC_STR;
	case SVM_EXIT_PUSHF:              return SVM_EXIT_PUSHF_STR;
	case SVM_EXIT_POPF:               return SVM_EXIT_POPF_STR;
	case SVM_EXIT_CPUID:              return SVM_EXIT_CPUID_STR;
	case SVM_EXIT_RSM:                return SVM_EXIT_RSM_STR;
	case SVM_EXIT_IRET:               return SVM_EXIT_IRET_STR;
	case SVM_EXIT_SWINT:              return SVM_EXIT_SWINT_STR;
	case SVM_EXIT_INVD:               return SVM_EXIT_INVD_STR;
	case SVM_EXIT_PAUSE:              return SVM_EXIT_PAUSE_STR;
	case SVM_EXIT_HLT:                return SVM_EXIT_HLT_STR;
	case SVM_EXIT_INVLPG:             return SVM_EXIT_INVLPG_STR;
	case SVM_EXIT_INVLPGA:            return SVM_EXIT_INVLPGA_STR;
	case SVM_EXIT_IOIO:               return SVM_EXIT_IOIO_STR;
	case SVM_EXIT_MSR:                return SVM_EXIT_MSR_STR;
	case SVM_EXIT_TASK_SWITCH:        return SVM_EXIT_TASK_SWITCH_STR;
	case SVM_EXIT_FERR_FREEZE:        return SVM_EXIT_FERR_FREEZE_STR;
	case SVM_EXIT_SHUTDOWN:           return SVM_EXIT_SHUTDOWN_STR;
	case SVM_EXIT_VMRUN:              return SVM_EXIT_VMRUN_STR;
	case SVM_EXIT_VMMCALL:            return SVM_EXIT_VMMCALL_STR;
	case SVM_EXIT_VMLOAD:             return SVM_EXIT_VMLOAD_STR;
	case SVM_EXIT_VMSAVE:             return SVM_EXIT_VMSAVE_STR;
	case SVM_EXIT_STGI:               return SVM_EXIT_STGI_STR;
	case SVM_EXIT_CLGI:               return SVM_EXIT_CLGI_STR;
	case SVM_EXIT_SKINIT:             return SVM_EXIT_SKINIT_STR;
	case SVM_EXIT_RDTSCP:             return SVM_EXIT_RDTSCP_STR;
	case SVM_EXIT_ICEBP:              return SVM_EXIT_ICEBP_STR;
	case SVM_EXIT_WBINVD:             return SVM_EXIT_WBINVD_STR;
	case SVM_EXIT_MONITOR:            return SVM_EXIT_MONITOR_STR;
	case SVM_EXIT_MWAIT:              return SVM_EXIT_MWAIT_STR;
	case SVM_EXIT_MWAIT_CONDITIONAL:  return SVM_EXIT_MWAIT_CONDITIONAL_STR;
	case SVM_EXIT_NPF:                return SVM_EXIT_NPF_STR;
	case SVM_EXIT_INVALID_VMCB:       return SVM_EXIT_INVALID_VMCB_STR;
    }
    return NULL;
}
