...
static int 
svm_disable_fpu_exits(struct v3_core_info * core) 
{
    struct cr0_32 * cr0       = (struct cr0_32 *)&(core->ctrl_regs.cr0);
    struct cr0_32 * guest_cr0 = (struct cr0_32 *)&(core->shdw_pg_state.guest_cr0);
...
static int 
svm_enable_fpu_exits(struct v3_core_info * core) 
{
    struct cr0_32 * cr0       = (struct cr0_32 *)&(core->ctrl_regs.cr0);
    struct cr0_32 * guest_cr0 = (struct cr0_32 *)&(core->shdw_pg_state.guest_cr0);
    vmcb_ctrl_t   * ctrl_area = GET_VMCB_CTRL_AREA((vmcb_t *)(core->vmm_data));
...
int 
v3_fpu_init(struct v3_core_info * core) 
{
...
int 
v3_fpu_on_entry(struct v3_core_info * core) 
{
    struct v3_fpu_state * fpu = &(core->fpu_state);
    struct cr0_32       * cr0 = (struct cr0_32 *)&(core->ctrl_regs.cr0);
...
int 
v3_fpu_deactivate(struct v3_core_info * core) 
{
    struct v3_fpu_state * fpu = &(core->fpu_state);
...
int 
v3_fpu_activate(struct v3_core_info * core) 
{
    struct v3_fpu_state * fpu = &(core->fpu_state);
