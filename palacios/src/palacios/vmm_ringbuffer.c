...
struct v3_ringbuf * 
v3_create_ringbuf(uint32_t size) 
{
...
void 
v3_free_ringbuf(struct v3_ringbuf * ring) 
{
    V3_Free(ring->buf);
    V3_Free(ring);
}
...
int 
v3_ringbuf_avail_space(struct v3_ringbuf * ring) 
{
...
int 
v3_ringbuf_data_len(struct v3_ringbuf * ring) 
{
...
int 
v3_ringbuf_capacity(struct v3_ringbuf * ring) 
{
    return ring->size;
}
...
void 
v3_print_ringbuf(struct v3_ringbuf * ring) 
{
    int ctr = 0;
